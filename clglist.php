...
<h3 align="center" id="meg1 "class="formhead">The list of colleges(few of them!!)</h3>
...
$result = $conn->query($sql);
    ...
    // output data of each row
        ...
        <tr class="head11"><td><h3>TN rank</h3></td><td><h3>College name</h3></td><td><h3>NIRF rank</h3></td>
        <td><h3>Founding year</h3></td><td><h3>Principal</h3></td><td><h3>Rating</h3></td>
        <td><h3>City</h3></td>
        <td><h3>Contact</h3></td>
        <td><h3>Email</h3></td>
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr>";
        echo "<td>".$row["tnRank"]."</td>"."<td>".$row["name"]."</td>"."<td>".$row["nirf"]."</td>"."<td>".$row["founded"]."</td>"."<td>".$row["principal"]."</td>"."<td>".$row["rating"]."</td>"."<td>".$row["city"]."</td>"."<td>".$row["contact"]."</td>"."<td>".$row["email"]."</td>";
